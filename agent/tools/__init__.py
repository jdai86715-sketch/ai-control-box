...
TOOL_SCHEMAS: list[dict[str, Any]] = [
    ...
    {"name": "get_system_time", "description": "Read the current local system date and time.", "parameters": {"type": "object", "properties": {}}},
    {"name": "get_weather", "description": "Read the current weather for the configured location.", "parameters": {"type": "object", "properties": {}}},
]
